...
def evaluate(model, data_loader):
    ...
    y_pred = []
    with torch.no_grad():
        for step, (g, nodes_feature, edges_weight, lengths, nodes, truth_data, users_frequency, time_matrixes, time_masks) in enumerate(
                tqdm(data_loader)):
            ...
            predict_data = model(g, nodes_feature, edges_weight, lengths, nodes, users_frequency, time_matrixes, time_masks)
