...
def train_model(model: nn.Module,
    ...
    for epoch in range(epochs):
        ...
        for name in name_list:
            ...
            for step, (g, nodes_feature, edges_weight, lengths, nodes, truth_data, users_frequency, time_matrixes, time_masks) in enumerate(tqdm_loader):
                g, nodes_feature, edges_weight, lengths, nodes, truth_data, users_frequency, time_matrixes, time_masks = \
                    convert_all_data_to_gpu(g, nodes_feature, edges_weight, lengths, nodes, truth_data, users_frequency, time_matrixes, time_masks)
                with torch.set_grad_enabled(name == 'train'):
                    # (B, N)
                    output = model(g, nodes_feature, edges_weight, lengths, nodes, users_frequency, time_matrixes, time_masks)
