...
class temporal_set_prediction(nn.Module):
    ...
    def __init__(self, items_total, timestamps_total, item_embedding_dim):
        """
        ...
        self.timestamp_embedding = nn.Embedding(timestamps_total, item_embedding_dim)

        self.item_embedding_dim = item_embedding_dim
        self.items_total = items_total
        self.timestamps_total = timestamps_total
    ...
    def forward(self, graph: dgl.DGLGraph, nodes_feature: torch.Tensor, edges_weight: torch.Tensor,
                ...
                time_matrixes: torch.Tensor, time_masks: torch.Tensor):
        """
        ...
        nodes_output = self.masked_self_attention(nodes_output, time_matrixes, time_masks)
